...
/**
 * bal - Calculates and adjusts the balance factor of an AVL tree.
...
/**
 * successor - Finds the in-order successor, i.e., the minimum value node
...
/**
 * remove_type - Removes a node from the tree based on its children.
